...
def encrypt(instring):
	...
	for i in range(len(content)):
		outstring += bit_byte(encryptBlock(byte_bit(content[i])))
	return outstring
...
def decrypt(instring):
	...
	outputstring = ''
	for i in range(len(content)):
		outputstring += bit_byte(decryptBlock(byte_bit(content[i]))).decode('hex')
